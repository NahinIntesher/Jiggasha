...
const Page = () => {
    ...
    const fetchModelTest = async () => {
        try {
            const response = await fetch(`http://localhost:8000/model-tests/single/${modelTestId}`, {
                method: "GET",
                headers: {
                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        <div className="flex items-center gap-4 p-2 min-w-[160px]">
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                <span className="text-2xl font-bold text-gray-800">{modelTest.test_duration} min</span>
                            </div>
                        </div>
                        {/* Total Marks */}
                        <div className="flex items-center gap-4 p-2 min-w-[160px]">
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                <span className="text-2xl font-bold text-gray-800">{modelTest.total_mark}</span>
                            </div>
                        </div>
                        {/* Total Questions */}
                        <div className="flex items-center gap-4 p-2 min-w-[160px]">
                            ...
                            <div className="flex flex-col items-start">
                                ...
                                <span className="text-2xl font-bold text-gray-800">{modelTest.total_questions}</span>
                            </div>
                        </div>
                    </div>
                </div>
