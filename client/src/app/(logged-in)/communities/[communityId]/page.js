...
import { FaAngleDown, FaMicrophone, FaPaperclip, FaPaperPlane, FaUser, FaUserGroup } from "react-icons/fa6";
          ...
          <div className="informationContainer">
            <div className="informations">
              ...
              <div className="information">
                ...
                <div className="text">
                  {community?.total_members}1 members
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="givePostBox">
        ...
        <div className="textBox">
          ...
          <div className="buttonContainer">
            ...
            <button type="submit" className="sendButton" onClick={handlePostSubmit}>
