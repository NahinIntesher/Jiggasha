                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl shadow-md border border-gray-300 p-6 mb-4">
                        <div className="flex justify-between items-center">
                            <div>
                                <h2 className="text-2xl font-bold text-[#ff7a1a]">Round {round}</h2>
                                <p className="text-gray-500">Question {pivot + 1} of {questions.length}</p>
                            </div>
                            <div className="text-right">
                                <div className="text-2xl font-bold text-[#ff7a1a]">{roundTimeLeft}s</div>
                    ...
                    <div className="bg-white rounded-xl shadow-md border border-gray-300 p-4 mb-4">
                        ...
                        <div className="flex gap-4">
                            {playerScores.map((player, index) => (
                                <div key={player.user_id} className="bg-gray-100 rounded-lg p-3 flex-1">
                                    <div className="font-semibold">{player.full_name}</div>
                                    <div className="text-[#ff7a1a] font-bold">{player.points} pts</div>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    {roundType == "mcq" && questions[pivot] && (
                        <div className="bg-white rounded-xl shadow-md border border-gray-300 p-6">
                            <div className="mb-6">
                                <h3 className="text-xl font-bold mb-4">{questions[pivot]?.content}</h3>
                            </div>
            ...
            <div className="min-h-[100dvh] flex items-center justify-center bg-[#fffaf3]">
                <div className="bg-white rounded-xl shadow-md border border-gray-300 px-10 pt-10 pb-8 min-w-[600px] max-w-[900px] w-[80%] text-center">
                    ...
                    <div className="mb-6">
                        ...
                        {playerScores.map((player, index) => (
                            <div key={player.user_id} className="bg-gray-100 rounded-lg p-3 mb-2 flex justify-between items-center">
                                <span className="font-semibold">{player.full_name}</span>
                                <span className="text-[#ff7a1a] font-bold">{player.points} pts</span>
                            </div>
                        ))}
                    </div>
                </div>
        ...
        return (
            <div className="min-h-[100dvh] flex items-center justify-center bg-[#fffaf3]">
                <div className="bg-white rounded-xl shadow-md border border-gray-300 px-10 pt-10 pb-8 min-w-[600px] max-w-[900px] w-[80%] text-center">
                    ...
                    <div className="text-gray-500 text-base mb-6 font-medium">
                        {mode === "pair" ? "Pair-to-Pair Battle" : "Battle Royale"} Complete!
                    </div>

                    {/* Final Results */}
                    <div className="mb-6">
                        {playerScores.map((player, index) => (
                            <div key={player.user_id} className={`rounded-lg p-4 mb-3 flex justify-between items-center ${index === 0 ? 'bg-yellow-100 border-2 border-yellow-400' : 'bg-gray-100'
                                }`}>
                                <div className="flex items-center">
                                    <span className="text-2xl mr-3">
                                        {player.rank}
                                    </span>
                                    <span className="font-semibold">{player.full_name} {index === 0 ? '🏆' : ``}</span>
                                </div>
                                <span className="text-[#ff7a1a] font-bold text-lg">{player.points} pts</span>
                            </div>
                        ))}
                    </div>
