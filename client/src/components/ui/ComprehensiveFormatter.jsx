      ...
      <ReactMarkdown
        ...
        components={{
          ...
          h1({ node, children, ...props }) {
            return <h1 className="text-2xl font-bold mt-8 mb-4 pb-2 border-b border-gray-200" {...props}>{children}</h1>;
          },
          ...
          h4({ node, children, ...props }) {
            return <h4 className="text-base font-bold mt-4 mb-2" {...props}>{children}</h4>;
          },
            ...
            return (
              <span className="block my-4">
                <img 
                  ...
                  {...props} 
                />
                {alt && <span className="text-sm text-gray-500 italic block mt-1">{alt}</span>}
              </span>
            );
          },
